/*
Copyright (c) Jeremy Bao (bao1018@gmail.com). All rights reserved.
...
s_a[252]="Bulawayo|Harare|ManicalandMashonaland Central|Mashonaland East|Mashonaland West|Masvingo|Matabeleland North|Matabeleland South|Midlands";
 ...
 ko.bindingHandlers.countryOptions = {
    init: function(element, valueAccessor, allBindings, viewModel, bindingContext) {
        var selector = $(element);
        selector.append($("<option></option>").text(allBindings.get('optionTitle') || 'Please select...'));
        country_arr.forEach(function(c){
           selector.append($("<option></option>").attr("value",c).text(c));
        });
       selector.change(function(){
        	valueAccessor()(selector.val());
        });
    },
    update: function(element, valueAccessor, allBindings, viewModel, bindingContext) {
       var value = valueAccessor();
       var statesOptField = allBindings.get('stateOptions');
       var valueUnwrapped = ko.unwrap(value);
       if(typeof(valueUnwrapped) == 'undefined')
       	statesOptField([])
       else{
       	 var strStates = s_a[country_arr.indexOf(valueUnwrapped) + 1];
         statesOptField(strStates.split('|'));
       }
